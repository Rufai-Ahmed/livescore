...
import { GiField, GiSoccerKick, GiHamburgerMenu } from "react-icons/gi";
...
const Sider = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`min-h-screen fixed top-0 left-0 bg-[#F73C46] w-64 p-6 z-30 transform transition-transform duration-300 ease-in-out ${
          ...
          <ul>
            ...
            <li className="mb-6">
              <a
                ...
                className="flex items-center text-white hover:text-gray-300"
              >
                <MdPayment className="mr-3 text-xl" />
                Payment
              </a>
            </li>
            <li className="mb-6">
